...
def ResNet50(input_tensor,
    ...
    x = conv_block(x, [192, 192, 384], stage=4, block='a')
    x = identity_block(x, [192, 192, 384], stage=4, block='b')
    x = identity_block(x, [192, 192, 384], stage=4, block='c')
    x = identity_block(x, [192, 192, 384], stage=4, block='d')
    x = identity_block(x, [192, 192, 384], stage=4, block='e')
    x = identity_block(x, [192, 192, 384], stage=4, block='f')

    x = conv_block(x, [384, 384, 768], stage=5, block='a')
    x = identity_block(x, [384, 384, 768], stage=5, block='b')
    x = identity_block(x, [384, 384, 768], stage=5, block='c')
